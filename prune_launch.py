...
TORCH_HOME = "/home/ys/projects/03_TENAS/"  # Path that contains the nas-bench-201 database. If you only want to run on NASNET (i.e. DARTS) search space, then just leave it empty
data_paths = {
    "cifar10": "/DATA/disk1/data/",
